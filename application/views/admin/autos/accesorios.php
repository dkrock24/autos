...
<section>
    ...
    <div class="content-wrapper">  
        <h3 style="height: 50px; font-size: 13px;">  
            ...
            <button type="button" style="top: -12px; position: relative;" class="mb-sm btn btn-info"> Accesorios</button>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="panelDemo10" class="panel panel-info">    
                            ...
                            <div class="panel-heading">Accesorios Auto : <?php //echo $onMenu[0]->nombre_submenu ?> </div>
                             <div class="panel-body">        
                            <p> 
                            <form class="form-horizontal" name="moneda" action='../save_accesorios' method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <div class="checkbox c-checkbox">
                                                    <label>
                                                       <input type="checkbox" name="<?php echo $value->Accesorio_id; ?>">
