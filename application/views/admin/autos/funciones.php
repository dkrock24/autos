                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="panelDemo10" class="panel panel-info">    
                            ...
                            <p> 
                            <form class="form-horizontal" name="moneda" action='../save_funciones' method="post">
                                ...
                                <div class="row">
                                    ...
                                    foreach ($funciones as $key => $value) {
                                        ...
                                        <div class="form-group">
                                            <label for="inputPassword3" class="col-sm-2 control-label no-padding-right"><?php echo $value->Function_name ?></label>
                                            <div class="col-sm-10">

                                                <div class="checkbox c-checkbox">
                                                    <label>
                                                       <input type="checkbox" name="<?php echo $value->Function_id; ?>">
