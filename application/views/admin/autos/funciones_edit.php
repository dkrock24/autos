...
<section>
    ...
    <div class="content-wrapper">  
        <h3 style="height: 50px; font-size: 13px;">  
            ...
            <button type="button" style="top: -12px; position: relative;" class="mb-sm btn btn-info"> Funciones</button>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="panelDemo10" class="panel panel-info">    
                            ...
                            <div class="panel-heading">Funciones Auto : <?php //echo $onMenu[0]->nombre_submenu ?> </div>
                             <div class="panel-body">        
                            <p> 
                            <form class="form-horizontal" name="moneda" action='../save_funciones1' method="post">
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                    foreach ($Allfunciones as $key => $f) {
                                        ?>

                                        <div class="form-group">
                                            <label for="inputPassword3" class="col-sm-2 control-label no-padding-right"><?php echo $f->Function_name ?></label>
                                            <div class="col-sm-10">
                                                ...
                                                <div class="checkbox c-checkbox">
                                                    <label>
                                                        ...
                                                        $check='';
                                                        if($carFunciones){
                                                        foreach ($carFunciones as $key => $value) {
                                                            if($f->Function_id == $value->Function_id ){
                                                                $check = "checked";    
                                                            }
                                                        }
                                                        }
                                                        ...
                                                        ?>
                                                       <input type="checkbox" <?php echo $check; ?>  name="<?php echo $f->Function_id; ?>">
