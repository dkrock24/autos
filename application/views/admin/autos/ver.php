                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="panelDemo10" class="panel panel-info">    
                            ...
                            <div class="panel-heading">Ver Auto : <?php //echo $onMenu[0]->nombre_submenu ?> </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <table class="table">
                                            <tr>
                                                <td>Marca</td>
                                                <td><?php echo $auto[0]->Brand_name ?></td>
                                            </tr>
                                            <tr>
                                                <td>Modelo</td>
                                                <td><?php echo $auto[0]->Brand_Line_name ?></td>
                                            </tr>
                                            <tr>
                                                <td>Descripcion</td>
                                                <td><?php echo $auto[0]->Car_description ?></td>
                                            </tr>
                                            <tr>
                                                <td>Precio Venta</td>
                                                <td><?php echo $auto[0]->Car_price_sale ?></td>
                                            </tr>

                                            <tr>
                                                <td>Precio Renta</td>
                                                <td><?php echo $auto[0]->Car_price_rental ?></td>
                                            </tr>
                                            <tr>
                                                <td>Negociable</td>
                                                <td><?php if($auto[0]->Car_negociable==1){ 
                                                    ?>
                                            ...
                                            <tr>
                                                <td>Año</td>
                                                <td><?php echo $auto[0]->Car_year ?></td>
                                            </tr>

                                            <tr>
                                                <td>Color</td>
                                                <td><?php echo $auto[0]->Car_color ?></td>
                                            </tr>
                                            <tr>
                                                <td>Creado</td>
                                                <td><?php $date = new DateTime($auto[0]->created); echo $date->format('M-d-Y / H:i');  ?></td>
                                            </tr>
                                            <tr>
                                                <td>Actualizado</td>
                                                <td><?php $date2 = new DateTime($auto[0]->updated); echo $date2->format('M-d-Y / H:i');  ?></td>
                                            </tr>

                                            <tr>
                                                <td>Estado</td>
                                                
                                                <td><?php if($auto[0]->Car_status==1){ 
                                                    ?>
